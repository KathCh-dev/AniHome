...
<body>
    <nav class="shadow-lg">
        <div class="flex justify-between">
            ...
            <a href="{{ route('login') }}"><button class="bg-purple-400 text-center text-yellow-50 font-bold text-base border border-3 border-purple-900 rounded-3xl m-2 p-2 hover:bg-purple-900">Se connecter ➜</button></a>
        </div>
    </nav>
